#!/usr/bin/env python3
"""
Test Few-Shot Learning Pipeline on Test-images Directory
"""
...
def main():
    """Main function to test pipeline on Test-images"""
    print("🏠 DSM Few-Shot Learning Pipeline Test - Test-images Directory")
    print("=" * 70)
    ...
    print(f"\nTesting {len(test_images)} images with few-shot learning...")
    print("-" * 70)
    ...
    # Save results to CSV
    csv_filename = f"test_images_pipeline_{datetime.now().strftime('%Y%m%d_%H%M%S')}.csv"
    ...
    # Print summary
    print("\n" + "=" * 70)
    print("📊 TEST-IMAGES PIPELINE RESULTS")
    print("=" * 70)
